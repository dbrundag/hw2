...
{
    Book* book = new Book("book", prodName_, author_, isbn_, price_, qty_);
    return book;
}
...
{
    Clothing* clothing = new Clothing("clothing", prodName_, size_, brand_, price_, qty_);
    return clothing;
}
...
{
    Movie* movie = new Movie("movie", prodName_, genre_, rating_, price_, qty_);
    return movie;
}
